...
def do_experiments(start, end, step_num):
    ...
    for i, distance in enumerate(shift_distances, 1):
        ...
        # Plot decision boundary as a contour line at Z=0.5
    ...
    plt.title("Shift Distance vs Decision Boundary Slope")
    plt.xlabel("Shift Distance")
    plt.ylabel("Slope")
    plt.ylim(-2, 0)

    # Plot decision boundary intercept
    plt.subplot(3, 3, 5)
    plt.plot(shift_distances, intercept_list, marker='o')
    plt.title("Shift Distance vs Decision Boundary Intercept")
    plt.xlabel("Shift Distance")
